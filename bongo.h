#define KEYS_SIZE 58 // the number of keys stored in the array that tracks keypresses; how many keys are on the board?
...
void set_animation_state(void) {
    bool new_key_press = check_if_new_key_press();
